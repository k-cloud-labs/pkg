...
// ClusterValidatePolicyListerExpansion allows custom methods to be added to
// ClusterValidatePolicyLister.
type ClusterValidatePolicyListerExpansion interface{}
